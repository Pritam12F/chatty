    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
      <Card className="group relative overflow-hidden hover:shadow-2xl hover:border hover:border-gray-800 hover:shadow-green-500/10 transition-all duration-500 cursor-pointer border-0 bg-background backdrop-blur-xl">
        ...
        <CardContent className="relative p-10 text-center">
          <div className="w-16 h-16 bg-gradient-to-br from-green-600 via-emerald-500 to-green-700 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-lg">
      ...
      <Card className="group relative overflow-hidden hover:shadow-2xl hover:border hover:border-gray-800 hover:shadow-red-500/20 transition-all duration-500 cursor-pointer border-0 bg-background backdrop-blur-xl">
        ...
        <CardContent className="relative p-10 text-center">
          <div className="w-16 h-16 bg-gradient-to-br from-red-600 via-red-500 to-red-700 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-lg">
            <Youtube className="w-10 h-10 text-white drop-shadow-sm" />
          </div>
          <h3 className="font-bold text-white mb-4 text-xl tracking-tight">
            Analyze Video
          </h3>
      ...
      <Card className="group relative overflow-hidden hover:shadow-2xl hover:border hover:border-gray-800 hover:shadow-purple-500/15 transition-all duration-500 cursor-pointer border-0 bg-background backdrop-blur-xl">
        ...
        <CardContent className="relative p-10 text-center">
          <div className="w-16 h-16 bg-gradient-to-br from-purple-600 via-purple-500 to-purple-700 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-lg">
      ...
      <Card className="group relative overflow-hidden hover:shadow-2xl hover:border hover:border-gray-800 hover:shadow-orange-500/15 transition-all duration-500 cursor-pointer border-0 bg-background backdrop-blur-xl">
        ...
        <CardContent className="relative p-10 text-center">
          <div className="w-16 h-16 bg-gradient-to-br from-orange-600 via-orange-500 to-orange-700 rounded-3xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-lg">
