        ...
        <div className="grid grid-cols-11 gap-y-6 sm:gap-y-0 sm:grid-cols-12">
          ...
          <div className="ml-5 sm:-ml-3 mt-3 sm:-mt-1 col-span-9 sm:col-span-4 md:col-span-3 lg:col-span-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="#"
                  className="text-gray-600 dark:text-gray-400 duration-300 hover:text-purple-700 dark:hover:text-blue-500"
                >
                  Privacy Policy
                </Link>
              </li>
          ...
          <div className="mt-6 ml-5 sm:ml-10 sm:-mt-1 col-span-3 mr-10 sm:col-span-3 md:col-span-3 lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <Link
                href="#"
                className="text-gray-600 duration-300 hover:text-purple-700 dark:text-gray-400 dark:hover:text-blue-600"
              >
              ...
              <Link
                ...
                className="text-gray-600 duration-300 hover:text-blue-700 dark:text-gray-400 dark:hover:text-blue-600"
              >
